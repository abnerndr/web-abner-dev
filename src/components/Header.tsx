  ...
  return (
    ...
    >
      <Image
        ...
        className={clsx(
          "rounded-full bg-zinc-100 object-cover saturate-100 dark:bg-zinc-800",
...
export function Header() {
  ...
  let isInitial: any = useRef(true);

  useEffect(() => {
    let downDelay = avatarRef.current?.offsetTop ?? 0;
    let upDelay = 64;

    function setProperty(property: string, value: string | number | any) {
